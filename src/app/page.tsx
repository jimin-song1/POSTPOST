...
export default function Home() {
  ...
  if (result) return <CustomerResult analysis={result.analysis} current={result.current} interpretation={interpretation} onInterpret={requestInterpretation} onRetry={requestInterpretation} onRestart={() => { setResult(null); setInterpretation({ status: "not_requested" }); }} />;
